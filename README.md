...
1 - First run CATALOG _CREATION.ipynb to crete the enviroment, with catalog, schemas, volumes and tables
...
4 - Run the Gold/GOLD_CSV_ANALYTICS.ipynb to see the answers to analytics questions of the case
